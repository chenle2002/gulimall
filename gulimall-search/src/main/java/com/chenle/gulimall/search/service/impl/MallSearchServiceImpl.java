package com.chenle.gulimall.search.service.impl;
...
import com.chenle.gulimall.search.feign.ProductFeignService;
import com.chenle.gulimall.search.service.MallSearchService;
    ...
    private SearchResult buildSearchResult(SearchResponse response, SearchParam param) {
        ...
        if (param.getAttrs() != null && param.getAttrs().size() > 0) {
            List<SearchResult.NavVo> collect = param.getAttrs().stream().map(attr -> {
                ...
                navVo.setLink("http://search.gulimall.com:547/list.html?" + replace);
